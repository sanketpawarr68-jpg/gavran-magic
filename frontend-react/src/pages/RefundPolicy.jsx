            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
                <section>
                    ...
                    <div style={{ background: '#fff7ed', padding: '25px', borderRadius: '16px', border: '1px solid #ffedd5', marginBottom: '20px' }}>
                        <h3 style={{ fontSize: '1.1rem', color: '#9a3412', marginBottom: '10px' }}><i className="fas fa-clock"></i> 3-Hour Grace Period</h3>
                        <p style={{ margin: 0, color: '#c2410c', lineHeight: '1.6' }}>
                            Because our kitchen starts preparing your fresh orders immediately, you can only cancel your order **within 2 to 3 hours** of placement. After this window, the order is confirmed and cannot be cancelled.
                        </p>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <p style={{ color: '#555', fontSize: '1.05rem', lineHeight: '1.7' }}>
                        As we deal in fresh, handmade food items, returns are generally not accepted for hygiene reasons. However, if you receive a damaged or incorrect product, we've got you covered!
                        <br /><br />
